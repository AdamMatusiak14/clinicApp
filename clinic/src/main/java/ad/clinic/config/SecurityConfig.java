    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http,
      ...
      http
        ...
        .authorizeHttpRequests(auth -> auth
            ...
            .requestMatchers("/assistant/description").permitAll() 
            ...
            .requestMatchers("/api/doctors/names").hasAnyRole("DOCTOR", "PATIENT")
            .requestMatchers("/api/doctor/panel").hasRole("DOCTOR")
            .requestMatchers("/api/visit/**").hasAnyRole("PATIENT", "DOCTOR")
